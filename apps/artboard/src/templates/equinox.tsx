...
const Header = () => {
	...
	return (
		<div className="p-custom text-text flex flex-col gap-5">
			<div className="text-5xl font-bold tracking-widest">{basics.name}</div>
			<div className="grid grid-cols-5">
				<div className="col-span-2 flex flex-col items-start gap-x-2 gap-y-1 text-base mr-3">
                ...
                <div className="wysiwyg col-span-3" dangerouslySetInnerHTML={{ __html: section.content }} />
...
const Section = <T,>({
	...
	if (section.id === "skills") {
		alignChanges = "flex flex-wrap px-1 gap-x-5 mb-4 gap-y-4 text-left";
	...
	return (
		<section id={section.id} className="grid">
			<h4 className="mb-9 mt-4 pb-0.5 text-4xl font-bold">{section.name}</h4>
...
export const Equinox = ({ columns, isFirstPage = false }: TemplateProps) => {
	const [main, sidebar] = columns;

	return (
		<div className="p-custom text-text grid min-h-[inherit] bg-background">
			{isFirstPage && (
				<>
					<Header />
				</>
			...
			<div className="grid grid-cols-5 gap-x-4 ">
				<div
					className="sidebar overflow-wrap-anywhere p-custom group col-span-2 space-y-4"
				>
					{sidebar.map((section) => (

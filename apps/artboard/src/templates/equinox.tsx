	...
	return (
		<div className="p-custom text-text flex flex-col gap-5">
			...
			<div className="grid grid-cols-5">
				<div className="col-span-2 flex flex-col items-start gap-x-2 gap-y-1 text-base">
					{basics.location && (
				...
				<div className="col-span-3 text-base">{basics.headline}</div>
			</div>
		</div>
	);
};
...
const Summary = () => {
	...
	return (
		<section id={section.id} className="group-[.sidebar]:border-b">
			<h4 className="mb-2 pb-0.5 text-2xl font-bold">{section.name}</h4>
...
const Section = <T,>({
	...
	return (
		<section id={section.id} className="grid">
			<h4 className="mb-9 pb-0.5 text-4xl font-bold">{section.name}</h4>

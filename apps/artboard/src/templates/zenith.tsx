...
const Section = <T,>({
    ...
    const itemClass = section.name === "Skills" ? "px-2 w-1/3" : "";

    const containerClass = section.name === "Skills" ? "grid grid-cols-3 gap-2" : "grid gap-x-6 gap-y-3";
    return (
    ...
    return (
        <div className="p-custom space-y-3">
            ...
            <div className="grid grid-cols-3 gap-x-4 ">
                {isFirstPage &&
                    <div className="sidebar p-4 bg-background group space-y-4">
                        <div className="border-b p-4">
                            <div className="text-primary text-2xl mb-2 font-bold" >CONTACT</div>
                            <div className="flex flex-col items-start gap-y-1.5 text-sm">
                                {basics.location && (
                                    <div className="flex items-center">
                                        <i className="ph ph-bold ph-map-pin group-[.main]:text-primary" />
                                        <div>{basics.location}</div>
                                    </div>
                                )}
                                {basics.phone && (
                                    <div className="flex items-center">
                                        <i className="ph ph-bold ph-phone group-[.main]:text-primary" />
                                ...
                                {basics.email && (
                                    <div className="flex items-center ">
                                        <i className="ph ph-bold ph-at group-[.main]:text-primary" />
                                ...
                                {basics.customFields.map((item) => (
                                    <div key={item.id} className="flex items-center">
                                        <i className={cn(`ph ph-bold ph-${item.icon} group-[.main]:text-primary`)} />
